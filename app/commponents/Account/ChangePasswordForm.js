...
export default function ChangePasswordForm (props){
    ...
    const onSubmit = async() => {
       ...
       if(!formData.password || 
            ...
            repearNewPassword: !formData.repeatNewPassword ? "La contraseña no puede estar vacía.": ""};
        }
        else if (formData.newPassword !== formData.repeatNewPassword){
           errorsTemp = {
               newPassword : "Las contraseñas no son iguales",
               repearNewPassword:"Las contraseñas no son iguales"
           };
       } else if(size(formData.newPassword)< 6){
           errorsTemp = {
               newPassword: "La contraseña tiene que ser  mayor a 6 caracteres",
               repearNewPassword: "La contraseña tiene que ser  mayor a 6 caracteres",
           };
       } else {
           setIsloading(true)
